...
```{r, fig.height=8.0, fig.width=6.5, tab.cap="xxx", tab.id="scenarios_interaction"}
#COMBINE PLOTS
...
#ggsave("Fig3.png", FIG3fin, width = 7, height=9, dpi="print", bg="white", scale=0.75)
```
